export default function MentionsGenerees() {
  return (
    <>
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> met
        à disposition des Clients : l'achat en ligne de cartes cadeaux, et une
        plateforme de réservation en ligne pour les prestations de massage
        bien-être.
      </p>
      <p>
      ...
      <p>
        ...
        détenues par{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> pour
      ...
      <p>
        ...
        site internet{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>{" "}
        l'identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi:
      </p>
      <p>
        <strong>Propriétaire</strong> : Entrepreneur Individuel dénommé Arthur
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> sont
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>, qui
      ...
      <p>
        Le site internet{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> a
        pour objet de fournir une information concernant l'ensemble des
        activités de la société.
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>{" "}
        s'efforce de fournir sur le site{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> des
      ...
      <p>
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> et
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> se
      ...
      <p>
        ...
        responsable du traitement des Données Personnelles est : Massage Reçu
        EI. <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>
        est représenté par Arthur FRIN, son représentant légal
      </p>
      <p>
        ...
        lesquelles{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> les
        traite.
      </p>
      ...
      <p>
        ...
        de <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>{" "}
      ...
      <div ng-bind-html="rgpdHTML">
        ...
        <p>
          <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>{" "}
          collecte en outre des informations à des fins statistiques en
          utilisant Google Analytics.
        </p>
        <p>
          {" "}
          Pour savoir comment ces données sont collectées et traitées consultez
          cette page dédiée :{" "}
          <a href="http://www.google.com/intl/fr/policies/privacy/partners/">
            http://www.google.com/intl/fr/policies/privacy/partners/
          </a>
          . Vous pouvez désactiver les fonctionnalités de Google Analytics à
          l'aide d'un module proposé par Google ; il se greffe sur les
          navigateurs et vient bloquer la transmission des données :{" "}
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>prend
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>.
        Cependant,{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> n'a
      ...
      <p>
        ...
        être le cas lorsque{" "}
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> ou
      ...
      <p>
        ...
        par <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>,
      ...
      <p>
        ...
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a>. À
      ...
      <p>
        <a href="https://www.massagerecu.fr">https://www.massagerecu.fr</a> peut
