  ...
  return (
    <>
      ...
      <p>
        ...
        Arthur, domiciliée au 1 Le Grand Long Pré 35150 Brie pour la vente des
        produits suivants : Carte cadeau - Massages.
      </p>
      ...
      <p>
        Vous pouvez passer commande sur Internet :{" "}
        <a href="www.massagerecu.fr">www.massagerecu.fr</a>. Les informations
        contractuelles sont présentées en langue française et feront l'objet
        d'une confirmation au plus tard au moment de la validation de votre
        commande. La société FRIN Arthur (Massage Reçu) se réserve le droit de
      ...
      <p>
        ...
        <a href="www.massagerecu.fr">www.massagerecu.fr</a> suppose l'adhésion
      ...
      <p>
        ...
        retours sont à effectuer par mail en envoyant la carte cadeau telle
        qu'elle a été livrée à l'acheteur (format numérique PDF / par mail). En
        cas d'exercice du droit de rétractation, la société FRIN Arthur (Massage
        Reçu) procédera au remboursement des sommes versées, dans un délai de 14
        jours suivant la notification de votre demande et via le même moyen de
      ...
      <p>
        ...
        vigueur. La responsabilité de la société FRIN Arthur (Massage Reçu) ne
      ...
      <p>
        ...
        Clientèle du professionnel). A défaut d'accord amiable ou en l'absence
        de réponse du professionnel dans un délai raisonnable d'un (1) mois, le
        Client consommateur au sens de l'article L.133-4 du code de la
        consommation a la possibilité de saisir gratuitement, si un désaccord
        subsiste, le médiateur compétent inscrit sur la liste des médiateurs
        établie par la Commission d'évaluation et de contrôle de la médiation de
        la consommation en application de l'article L.615-1 du code de la
        consommation, à savoir :
      </p>
      <p>
        <img
          src="/assets/img/logo-SMPMC.webp"
          alt="Logo de la Société de la Médiation Professionnelle"
          width="350px"
          height="auto"
        />
        <br />
        ...
        <br />
        <a href="https://www.mediateur-consommation-smp.fr" target="_blank">
          www.mediateur-consommation-smp.fr
        </a>
        <br />5 rue Salvaing - 12000 Rodez
      </p>
      <h2>Article 12 - Propriété intellectuelle</h2>
      <p>
        Tous les éléments du site{" "}
        <a href="www.massagerecu.fr">www.massagerecu.fr</a> sont et restent la
        propriété intellectuelle et exclusive de la société FRIN Arthur (Massage
        Reçu). Nul n'est autorisé à reproduire, exploiter, rediffuser, ou
        utiliser à quelque titre que ce soit, même partiellement, des éléments
        du site qu'ils soient logiciels, visuels ou sonores. Tout lien simple ou
        par hypertexte est strictement interdit sans un accord écrit exprès de
        la société FRIN Arthur (Massage Reçu).
      </p>
      <h2>Article 13 - Données personnelles</h2>
      <p>
        La société FRIN Arthur (Massage Reçu) se réserve le droit de collecter
        les informations nominatives et les données personnelles vous
        concernant. Elles sont nécessaires à la gestion de votre commande, ainsi
        qu'à l'amélioration des services et des informations que nous vous
        adressons. Elles peuvent aussi être transmises aux sociétés qui
        contribuent à ces relations, telles que celles chargées de l'exécution
        des services et commandes pour leur gestion, exécution, traitement et
        paiement. Ces informations et données sont également conservées à des
        fins de sécurité, afin de respecter les obligations légales et
      ...
      <p>
        La société FRIN Arthur (Massage Reçu) archivera les bons de commandes et
        les factures sur un support fiable et durable constituant une copie
        fidèle conformément aux dispositions de l'article 1348 du Code civil.
        Les registres informatisés de la société FRIN Arthur (Massage Reçu)
